...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Office Location</h1>
                    ...
                    <form method="POST" action="{{ route('admin.offices.update', $office->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $office->address) }}" required>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude', $office->latitude) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="any" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude', $office->longitude) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('radius') is-invalid @enderror" id="radius" name="radius" value="{{ old('radius', $office->radius) }}" required min="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="check_in_deadline" class="form-label">Check-in Deadline</label>
                                <input type="time" class="form-control @error('check_in_deadline') is-invalid @enderror" id="check_in_deadline" name="check_in_deadline" value="{{ old('check_in_deadline', $office->check_in_deadline) }}" required>
                                <div class="form-text">Employees checking in after this time will be marked as late</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let marker = L.marker([{{ $office->latitude }}, {{ $office->longitude }}], {draggable: true}).addTo(map);
