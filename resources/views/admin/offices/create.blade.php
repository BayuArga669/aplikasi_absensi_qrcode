                    ...
                    <form method="POST" action="{{ route('admin.offices.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" class="form-control @error('check_in_deadline') is-invalid @enderror" id="check_in_deadline" name="check_in_deadline" value="{{ old('check_in_deadline', '09:00') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" class="form-control @error('check_out_deadline') is-invalid @enderror" id="check_out_deadline" name="check_out_deadline" value="{{ old('check_out_deadline', '17:00') }}" required>
