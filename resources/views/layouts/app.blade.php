...
<head>
    ...
    <style>
        ...
        /* For mobile view: sidebar dropdown dari atas */
        ...
        /* For desktop view: sidebar fixed di samping */
            ...
            <div class="list-group list-group-flush">
                @auth
                    @if(auth()->user()->role === 'admin')
                        ...
                        </a>                        </a>                        <a href="{{ route('admin.leave-requests') }}" class="list-group-item list-group-item-action {{ Request::is('admin/leave*') ? 'active' : '' }}">
